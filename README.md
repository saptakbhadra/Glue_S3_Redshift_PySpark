...
- [Workflow Picture](Images/Workflow Success.png) - Link to the picture showcasing the automated Glue Workflow.
- [Output Picture](Images/Data In Target Table.png) - Link to the picture displaying the final output.
